      ...
      <LoadingWrapper :loading="loading">
        <VForm class="form--wrapper" style="display: flex; flex-direction: column;" as="div" ref="loginForm">
          <div class="row">
            ...
            <div style="display: flex; flex-direction: column; align-items: flex-start; gap: .5rem; font-size: 1.5rem;" class="col-6">
              <label>Aktywny</label>
              <input
                type="checkbox"
...
async function send() {
  ...
  if (valid) {
    try {
      ...
      Object.entries(payloadFalsy).forEach(([key, value]) => {
